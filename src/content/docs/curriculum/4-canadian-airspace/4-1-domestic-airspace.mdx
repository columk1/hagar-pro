---
title: '4.1 Canadian Domestic Airspace & Uncontrolled Airspace'
description: 'Southern vs Northern Domestic Airspace, controlled vs uncontrolled airspace, and Class G rules.'
---

This section covers the broad geographic divisions of Canadian airspace, the difference between controlled and uncontrolled airspace, and the rules of Class G airspace.
...
Some small pieces of airspace are designated as Special Use airspace (Class F airspace). Class F airspace
can exists in uncontrolled airspace, controlled airspace or a combination of both.
...
:::note
Just because there are no restrictions to flying hang gliders in Class G airspace does not mean there are no rules. All the CARs that are not airspace-specific are still applicable in Class G airspace.
:::
