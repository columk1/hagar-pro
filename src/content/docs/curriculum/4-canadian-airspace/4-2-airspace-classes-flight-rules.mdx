---
 title: '4.2 Controlled Airspace (Classes A through E)'
...
It is found in [low-level airways](../../3-vnc-charts/3-3-airways-and-navaids/), control area extensions, transition areas, or CZs without an operating control tower.
