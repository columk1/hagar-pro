---
title: '3.4 Magnetic Variation & Navigation'
...
The variation for a specific isogonic line is shown on the VNC along the line (for example, **14°W**). You can see this in the [VNC excerpt](/images/vnc-detail-coordinates.avif) from [section 3.5](../3-5-map-work-locating-features).
