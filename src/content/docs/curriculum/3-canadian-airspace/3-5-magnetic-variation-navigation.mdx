---
title: '3.5 Magnetic Variation and Navigation'
...
The variation for a specific isogonic line is shown on the VNC along the line (for example, **14°W**). You can see this in the [VNC excerpt](/images/vnc-detail-coordinates.avif) from [section 3.4](../3-4-map-work-locating-features).
